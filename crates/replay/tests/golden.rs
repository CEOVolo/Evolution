...
fn golden_hashes() {
    ...
    assert_eq!(hash_after(1, 100), 0x2631_2531_5662_0c19, "seed=1 tick=100");
    assert_eq!(hash_after(1, 500), 0x2d4b_b726_6274_0a06, "seed=1 tick=500");
    assert_eq!(
        hash_after(1, 1000),
        0xc775_89e3_9deb_5a46,
        "seed=1 tick=1000"
    );
    assert_eq!(
        hash_after(2, 2000),
        0x284a_44a7_885e_9d57,
        "seed=2 tick=2000"
    );
}
