...
#[test]
fn golden_hashes() {
    assert_eq!(hash_after(1, 100), 0x2fd1_bef0_9138_723e, "seed=1 tick=100");
    assert_eq!(hash_after(1, 500), 0xa762_630d_5e6a_4a2a, "seed=1 tick=500");
    assert_eq!(
        hash_after(1, 1000),
        0x5070_ba86_25ae_d5c3,
        "seed=1 tick=1000"
    );
    assert_eq!(
        hash_after(2, 2000),
        0x9b4c_638c_760e_9629,
        "seed=2 tick=2000"
    );
}
